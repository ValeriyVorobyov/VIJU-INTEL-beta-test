...
mypath_dir = "C:/Users/V5/Documents/EVE/logs/Chatlogs/"
...
def perebor_files(list_path_files):
    ...
    for one_file_path in list_path_files:
        ...
        int = files_sravnivaem_datatime_iz_perebora(data_time_format_iz_perebira)
        
        if int == 1:
              itogovity_path = one_file_path
              path_live =  one_file_path
            
        else: itogovity_path = path_live
...
def max_path_live():
   ...
   print(" string_1.py - >  def max_path_live(): ")
   # print(files)
   # print("                                      ")
   # print("                                      ")
...
def kol_strok():
   ...
   except: print(" !!!! вышло хреново в  string_1 ->  kol_strok():  !!!! ")
