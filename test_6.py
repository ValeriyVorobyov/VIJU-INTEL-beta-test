...
btn_aTEST = Button(text="T E S T", command=click_TEST_button)
btn_aTuKTuK = Button(text="TyK-TyK", command=click_TuKTuK_button)
...
aSB7IT = canva_1.create_window(sistem_x+455, sistem_y+260, anchor=NW, window=btn_aSB7IT, width=btn_window_width, tags=["S-B7IT"])
aBKGQ2 = canva_1.create_window(sistem_x+455, sistem_y+295, anchor=NW, window=btn_aBKGQ2, width=btn_window_width, tags=["BKG-Q2"])
aZK495 = canva_1.create_window(sistem_x+280, sistem_y+210, anchor=NW, window=btn_aZK495, width=btn_window_width, tags=["Z-K495"])
a84GQM = canva_1.create_window(sistem_x+315, sistem_y+294, anchor=NW, window=btn_a84GQM, width=btn_window_width, tags=["8-4GQM"])
aLXWNW = canva_1.create_window(sistem_x + 267, sistem_y + 410, anchor=NW, window=btn_aLXWNW, width=btn_window_width,
                               tags=["LXWN-W"])

aCHCGU = canva_1.create_window(sistem_x + 500, sistem_y + 210, anchor=NW, window=btn_aCHCGU, width=btn_window_width,
                               tags=["C-HCGU"])
...
#                                tags=["4-48K1"])
aQFEEJ = canva_1.create_window(sistem_x + 430, sistem_y + 210, anchor=NW, window=btn_aQFEEJ, width=btn_window_width,
                               tags=["Q-FEEJ"])
a0P9ZI = canva_1.create_window(sistem_x + 360, sistem_y + 210, anchor=NW, window=btn_a0P9ZI, width=btn_window_width,
                               tags=["0P9Z-I"])
aXM4L0 = canva_1.create_window(sistem_x + 205, sistem_y + 210, anchor=NW, window=btn_aXM4L0, width=btn_window_width,
                               tags=["XM-4L0"])


aOJA8M = canva_1.create_window(sistem_x + 730, sistem_y + 260, anchor=NW, window=btn_aOJA8M, width=btn_window_width,
                               tags=["OJ-A8M"])
...
aRO90H = canva_1.create_window(sistem_x + 267, sistem_y + 443, anchor=NW, window=btn_aRO90H, width=btn_window_width, tags=["RO90-H"])
aMAVDX = canva_1.create_window(sistem_x + 267, sistem_y + 475, anchor=NW, window=btn_aMAVDX, width=btn_window_width, tags=["MA-VDX"])
a92DOI = canva_1.create_window(sistem_x + 267, sistem_y + 524, anchor=NW, window=btn_a92DOI, width=btn_window_width, tags=["92D-OI"])
aWOAIJ = canva_1.create_window(sistem_x + 195, sistem_y + 443, anchor=NW, window=btn_aWOAIJ, width=btn_window_width, tags=["WO-AIJ"])
a1GMJE = canva_1.create_window(sistem_x + 195, sistem_y + 475, anchor=NW, window=btn_a1GMJE, width=btn_window_width, tags=["1G-MJE"])
aCLP3N = canva_1.create_window(sistem_x + 195, sistem_y + 410, anchor=NW, window=btn_aCLP3N, width=btn_window_width, tags=["C-LP3N"])
a9F7PZ = canva_1.create_window(sistem_x + 195, sistem_y + 379, anchor=NW, window=btn_a9F7PZ, width=btn_window_width, tags=["9F-7PZ"])


aZXAV6 = canva_1.create_window(sistem_x + 205, sistem_y + 256, anchor=NW, window=btn_aZXAV6, width=btn_window_width,
                               tags=["ZXA-V6"])
aTQ2DD = canva_1.create_window(sistem_x + 281, sistem_y + 265, anchor=NW, window=btn_aTQ2DD, width=btn_window_width,
                               tags=["T-Q2DD"])
...
aTEST = canva_1.create_window(sistem_x+755, sistem_y+630, anchor=NW, window=btn_aTEST, width=btn_window_width, tags=["TEST"])
aTuKTuK = canva_1.create_window(sistem_x+830, sistem_y+630, anchor=NW, window=btn_aTuKTuK, width=btn_window_width, tags=["TuK-TuK"])
...
sb7it_bkgq2 = canva_1.create_line(sistem_x + 486, sistem_y + 295, sistem_x + 486, sistem_y + 285, fill="burlywood4", splinesteps=0,
                    width=my_wwidth_01)
#-240y
bkgq2_zk495 = canva_1.create_line(sistem_x + 280, sistem_y + 220, sistem_x + 455, sistem_y + 306, fill="burlywood4",
...
lxwnw_bkgq2 = canva_1.create_line(sistem_x + 300, sistem_y + 375, sistem_x + 455, sistem_y + 309, fill="burlywood4",
                                  splinesteps=5, width=my_wwidth_01)
...
v8wqs_oja8m = canva_1.create_line(sistem_x + 667, sistem_y + 272, sistem_x + 743, sistem_y + 272, fill="burlywood4",
                                  splinesteps=0, width=my_wwidth_01)
oja8m_h1esn = canva_1.create_line(sistem_x + 780, sistem_y + 272, sistem_x + 841, sistem_y + 272, fill="burlywood4",
                                  splinesteps=0, width=my_wwidth_01)
...
xm4l0_xw2xp = canva_1.create_line(sistem_x + 245, sistem_y + 221, sistem_x + 582, sistem_y + 221, fill="burlywood4",
                                  splinesteps=0, width=my_wwidth_01)

g_clp3n_lxwnw = canva_1.create_line(sistem_x + 300, sistem_y + 536, sistem_x + 300, sistem_y + 375, fill="burlywood4",
                                  splinesteps=0, width=my_wwidth_01)
...
tq2dd_zxav6 = canva_1.create_line(sistem_x + 270, sistem_y + 270, sistem_x + 280, sistem_y + 277, fill="burlywood4",
                                  splinesteps=0, width=my_wwidth_01)
