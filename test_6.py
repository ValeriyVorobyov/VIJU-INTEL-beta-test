...
path_live = "C:/Users/V5/Documents/EVE/logs/Chatlogs/"
...
# resized_image = image2.resize((24, 24))
    ...
    # # Необходимо сохранить ссылку на изображение, чтобы оно не удалилось сборщиком мусора
...
sound_menu = Menu()
sound_menu.add_command(label="Alarm sound-1", command=alarm_sound)
# sound_menu.add_command(label="Alarm sound-2", command=alarm_sound)
# sound_menu.add_command(label="Alarm sound-3", command=alarm_sound)
...
canva_1.create_line(530, 141, 530, 148, fill="burlywood4", splinesteps=10, width=my_wwidth_01)
...
canva_1.create_line(190, 17, 255, 65, fill="burlywood4", splinesteps=5, width=my_wwidth_01)
canva_1.create_line(180, 57, 255, 66, fill="burlywood4", splinesteps=5, width=my_wwidth_01)

line_LXWNW_BKG = canva_1.create_line(85, 134, 255, 67, fill="burlywood4", splinesteps=5, width=my_wwidth_01)
...
canva_1.create_line(600, 90, 600, 101, fill="burlywood4", splinesteps=0, width=my_wwidth_01)
canva_1.create_line(667, 90, 667, 101, fill="burlywood4", splinesteps=0, width=my_wwidth_01)
canva_1.create_line(563, 120, 670, 120, fill="burlywood4", splinesteps=0, width=my_wwidth_01)

canva_1.create_line(563, 77, 670, 77, fill="burlywood4", splinesteps=0, width=my_wwidth_01)
...
def proverka_na_sovpadenia():
     ...
     for elements in find_all_canvas:
          ...
          if  canva_1.itemcget(elements, "tags") in last_line_text and "clr" in last_line_text :   
